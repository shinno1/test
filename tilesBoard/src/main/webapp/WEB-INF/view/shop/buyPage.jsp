...
<body>
<form id="buyForm" action="insertBuy.sh" method="post">
<input type="hidden" name="goodsId" value="${goodsDetail.goodsId }">
<input type="hidden" name="goodsName" value="${goodsDetail.goodsName }">
<input type="hidden" name="orderPrice" id="hiddenOrderPrice" value="${goodsDetail.goodsPrice * cnt + goodsDetail.goodsDeliveryPrice }">
                     ...
                     <table class="table table-striped">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>${goodsDetail.goodsPoint }원</td>
                              <td><input type="number" class="buyCnt" name="orderGoodsCnt" value="${cnt }" style="width: 70%; text-align: center;"></td>
                              <td>${goodsDetail.goodsDeliveryPrice }원</td>
            ...
            <div class="panel panel-info">
               ...
               <div class="panel-body">
                  <div class="form-horizontal text-right">
                     <h4><span style="font-weight: bold; color: red;" id="totalPrice">${goodsDetail.goodsPrice * cnt + goodsDetail.goodsDeliveryPrice }원</span></h4>
                  </div>
               </div>
            </div>
            <div class="row">
...
<script src="resources/js/buyPage.js?ver=8"></script>
</body>
</html>